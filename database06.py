...
# Sheet configuration
SHEET_ID = "13cxu4fvko4XqUqyGTnK32mvDQKFDtri2vzC55GnX7D4"  # Replace with your Google Sheet ID
...
def load_products():
    products_sheet = get_worksheet('potproducts')
    if products_sheet:
...
def load_orders():
    orders_sheet = get_worksheet('potorders')
    if orders_sheet:
